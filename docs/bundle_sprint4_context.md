...
Build the most reliable open-source toolkit for migrating knowledge into Obsidian while preserving content, metadata, attachments and relationships.
...
- Refactor Evernote importer to use ProcessingPipeline
- Restore internal Evernote note links
- Improve ENML → Markdown conversion
- Notebook and Stack support
- Tag improvements
- Attachment verification
- Archive validation
- Import summary report
- Regression test suite using real-world ENEX archives

Goal

A user must be able to archive Evernote completely and continue working only in Obsidian.
...
Goals
- Expand CLI command structure.
- Add `unobit.yaml` configuration support.
- Add local HTML/JavaScript GUI prototype.
- Add JSON/HTML report viewing.
- Prepare public beta release.
